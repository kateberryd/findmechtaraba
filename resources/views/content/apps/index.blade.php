            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        <h6 class="section-subtitle ltn__secondary-color">Available Mechanics</h6>
                        <h1 class="section-title">Nearest Mechanics</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="ltn__small-product-item">
                        <div class="small-product-item-img">
                            <a href="product-details.html"><img src="/uploads/{{$vendor->shop_image}}" alt="Image"></a>
                        </div>
                        <div class="small-product-item-info">
                            
                            <h2 class="product-title"><a href="product-details.html">{{$vendor->company_name}}</a></h2>
...
<!-- Body main wrapper end -->    
    ...
    <script src="https://maps.google.com/maps/api/js?keyAIzaSyAJLga2AtOFaX13wAzkopq6hISmzv6rdzo=&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
